...
export const AddProductToQuoteModal = ({ 
  isOpen, 
  onClose, 
  products,
  categories,
  ...
  // Agregar producto a la cotización optimizada con useCallback
  const handleAddToQuote = useCallback((product: Product, quantity: number = 1) => {
  ...
  const handleAddSelectedProducts = useCallback(() => {
    ...
    onClose();
  }, [selectedProducts, products, onAddToQuote, onClose]);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-4 lg:p-6 border-b">
          <h2 className="text-lg lg:text-2xl font-bold">Agregar Productos a la Cotización</h2>
          ...
          {selectedProducts.size > 0 && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 lg:p-4">
              ...
              <div className="text-xs lg:text-sm text-blue-600">
                Los productos seleccionados se agregarán a la cotización. Puedes continuar seleccionando más productos.
              </div>
            </div>
          )}
